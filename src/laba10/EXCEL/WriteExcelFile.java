...
public class WriteExcelFile {
    public static void main(String[] args) throws IOException {
        ...
        headerRow.createCell(0).setCellValue("Характеристики");
        headerRow.createCell(0).setCellValue("Стоимость");
        ...
        dataRow2.createCell(1).setCellValue("Процессор: Intel Core i5, Оперативная память: Crucial");
